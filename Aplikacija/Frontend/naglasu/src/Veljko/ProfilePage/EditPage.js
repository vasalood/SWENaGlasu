...
return(<div className="container rounded bg-white mt-5 mb-5" style={{ width: '100%', height: '100%' }}>
    <div className="row">
        <div className="col-md-3 border-right">
            <div className="d-flex flex-column align-items-center text-center p-3 py-5"><img className="rounded-circle mt-5" width="150px" src={slika}/><span className="font-weight-bold">vveljko</span><span className="text-black-50">veljkoveljovic13@gmail.com</span><span> </span></div>
        </div>
