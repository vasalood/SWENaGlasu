        ...
        <div className="col-md-5 border-right">
            <div className="p-3 py-5">
                ...
                <div className="row mt-2">
                    <div className="col-md-6"><label className="labels">Ime</label><input type="text" className="form-control" placeholder={user.name} /></div>
                    <div className="col-md-6"><label className="labels">Prezime</label><input type="text" className="form-control" placeholder={user.surname}/></div>
                </div>
                <div className="row mt-3">
                    <div className="col-md-12"><label className="labels">Broj telefona</label><input type="text" className="form-control" placeholder="enter phone number" /></div>
                    <div className="col-md-12"><label className="labels">Adresa stanovanja</label><input type="text" className="form-control" placeholder="enter address line 1" /></div>
